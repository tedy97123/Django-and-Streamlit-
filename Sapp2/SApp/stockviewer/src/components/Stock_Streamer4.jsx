...
let AlpacaConnection4 = async (socket, get_data, setQuote, setTrade, setChart) =>
{
    ...
    const subscribe = {"action":"subscribe","trades":["TRXUSD"],"quotes":["TRXUSD"],"bars":["TRXUSD"]};
...
/*     console.log(start); */
    var bars_url = `"https://data.alpaca.markets/v1beta1/${crypto}/TRXUSD/bars?exchanges=CBSE&timeframe=1Min&start="` + start;
    ...
    var response = await fetch_api.json()
    ...
    socket.onmessage = (event) =>
    {
        ...
        {
            message = 'connected'
            return socket.send(JSON.stringify(auth, subscribe));
        };
...
export default AlpacaConnection4;
