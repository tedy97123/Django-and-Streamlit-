...
let AlpacaConnection3 = async (socket, get_data, setQuote, setTrade, setChart) =>
{
    ...
    const subscribe = {"action":"subscribe","trades":["LTCUSD"],"quotes":["LTCUSD"],"bars":["LTCUSD"]};
...
/*     console.log(start); */
    var bars_url = 'https://data.alpaca.markets/v1beta1/crypto/LTCUSD/bars?exchanges=CBSE&timeframe=1Min&start=' + start;
...
export default AlpacaConnection3;
